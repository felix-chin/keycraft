  ...
  return (
    <section className="modal-overlay modal-shade d-flex">
      <div className="disclaimer-content text-white p-3">
        <p>This application is for demonstration purposes only and the products listed are not actually for sale. Please do not enter any real financial information.</p>
